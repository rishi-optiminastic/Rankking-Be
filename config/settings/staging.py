...
# Inherit base's ResendEmailBackend so staging exercises the real transport.
...
if BLOG_DATABASE_URL:
    DATABASES["blog"] = dj_database_url.parse(BLOG_DATABASE_URL, conn_max_age=600, ssl_require=True)
